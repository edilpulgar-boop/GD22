...
// Teclado táctil / virtual (Android, iOS): el auto-cierre de ( ) [ ] { } " '
// también se maneja aquí porque algunos teclados no disparan un keydown
// confiable para esos caracteres.
// IMPORTANTE: el borrado inteligente (Backspace) NO se intercepta aquí a
// propósito — Android usa este mismo evento (deleteContentBackward) para
// el gesto de "arrastrar la barra espaciadora para mover el cursor", y si
// nuestro código borra más de un carácter de una, ese gesto se desincroniza
// y el cursor se traba al intentar moverse hacia la derecha. El borrado
// inteligente sigue funcionando por keydown (teclado físico y la mayoría
// de teclados táctiles al tocar la tecla de borrar).
