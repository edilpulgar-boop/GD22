...
// NOTA: el auto-cierre de ( ) [ ] { } " ' y el borrado inteligente se
// manejan solo por keydown (justo abajo), a propósito. Se había agregado
// también un listener de 'beforeinput' pensando en teclados táctiles poco
// confiables, pero ese es el mismo canal que usa el gesto de Android de
// "arrastrar la barra espaciadora para mover el cursor" — interceptarlo,
// aunque sea solo para insertar texto, lo desincroniza y el cursor se traba
// al moverse hacia la derecha. Los caracteres normales sí disparan keydown
// de forma confiable (a diferencia de Backspace/Enter), así que no hace
// falta ese respaldo aquí.
