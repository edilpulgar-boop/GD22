...
codeEl.addEventListener('keydown', (e) => {
  ...
  if (e.key === 'Backspace' && !e.ctrlKey && !e.metaKey && !e.altKey) {
    if (trySmartBackspace()) e.preventDefault();
  }
...
// Teclado táctil / virtual (Android, iOS): muchos no disparan un keydown
// confiable para Backspace, pero sí el evento beforeinput.
codeEl.addEventListener('beforeinput', (e) => {
  if (e.inputType === 'deleteContentBackward' && trySmartBackspace()) {
    e.preventDefault();
  }
});
