// ---- alto de la app fijo de verdad ----
// Lo medimos UNA sola vez al cargar (antes de que exista ningún teclado) y
// lo dejamos fijo en píxeles. A propósito NO escuchamos resize ni
// visualViewport aquí: eso es justo lo que hacía que el teclado moviera
// todo. Solo se vuelve a medir si el celular gira de verdad.
...
document.getElementById('clearBtn').addEventListener('click', closeAllDropdowns);
document.getElementById('clearCodeBtn').addEventListener('click', closeAllDropdowns);
